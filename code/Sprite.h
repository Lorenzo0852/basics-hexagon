//
// Created by loren on 07/07/2021.
//

#ifndef BASICS_PROJECT_TEMPLATE_SPRITE_H
#define BASICS_PROJECT_TEMPLATE_SPRITE_H
    ...
    public:
        ...
        float get_left_x () const
        {
            return
                    ...
                    (anchor & 0x3) == basics::RIGHT ? position[0] - size[0] * scale :
                    position[0] - size[0] * .5f * scale;
        }

        float get_right_x () const
        {
            return get_left_x () + size.width * scale;
        }
        ...
        float get_bottom_y () const
        {
            return
                    ...
                    (anchor & 0xC) == basics::TOP    ? position[1] - size[1] * scale :
                    position[1] - size[1] * .5f * scale;
        }

        float get_top_y () const
        {
            return get_bottom_y () + size.height * scale;
        }
...
#endif //BASICS_PROJECT_TEMPLATE_SPRITE_H
